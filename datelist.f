...
c Version: January 11, 2024
  ...
  20  continue
      ...
      write(15,330) name
      write(15,340)
      filvec='unarr_vect'//cf(it4)//cf(it3)//cf(it2)//cf(it1)//'.d'
  ...
  30  continue
     ...
     *,gox,skx,rast,vrel,angl
      read(10,*) xa,ya,za,vax,vay,vaz,vshx,vshy,vshz
      if(iarc.eq.1) then
        arc=' postperih.'
      else
        arc=' preperih.'
  ...
  40  continue
        ...
        if(irk.eq.jyear) then
          ...
          vshkmsz=vshz*prem
      if(iaux.le.9) then
        write(15,350) iaux,isx,jnn,arc,dr,rast,vrel,angl,irk,ims,den
      write(16,400) iaux,isx,xa,ya,za,vakmsx,vakmsy,vakmsz,vshkmsx,vshkm
     *sy,vshkmsz
      endif
      if(iaux.ge.10.and.iaux.le.99) then
        write(15,360) iaux,isx,jnn,arc,dr,rast,vrel,angl,irk,ims,den
      write(16,410) iaux,isx,xa,ya,za,vakmsx,vakmsy,vakmsz,vshkmsx,vshkm
     *sy,vshkmsz
      endif
      if(iaux.ge.100.and.iaux.le.999) then
        write(15,370) iaux,isx,jnn,arc,dr,rast,vrel,angl,irk,ims,den
      write(16,420) iaux,isx,xa,ya,za,vakmsx,vakmsy,vakmsz,vshkmsx,vshkm
     *sy,vshkmsz
      endif
      if(iaux.ge.1000) then
        write(15,380) iaux,isx,jnn,arc,dr,rast,vrel,angl,irk,ims,den
      write(16,430) iaux,isx,xa,ya,za,vakmsx,vakmsy,vakmsz,vshkmsx,vshkm
     *sy,vshkmsz
      endif
        else
          j=j+jjgo
          dni=tcros+j*pp
          if(dni.le.1.7214235d6.or.dni.gt.5.3734835d6) goto 30
          goto 40
        endif
      goto 30
  50  continue
