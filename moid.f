...
c Version: August 17, 2022
      ...
      dimension ea(5),eb(5),q(1500),ecc(1500),jnn(1500),xv1(6),xv2(6)
...
c       read(*,*) jjyy
      ...
      do i=1,jsh
        ...
        ea(4)=gom(i)
        ea(5)=sk(i)
        call approach(ea,eb,fkpo,fapo,rpo,xv1,fkpre,fapre,rpre,xv2)
        if(rpost.le.rcrit.or.rpre.le.rcrit) then
          write(15,300) name,fapo,fapre,rpo,rpre
          write(15,320) iau(i),isol(i),jnn(i),fkpo,fkpre
          write(15,340) q(i),ecc(i),som(i),gom(i),sk(i)
          write(15,360) xv1(1),xv1(2),xv1(3),xv1(4),xv1(5),xv1(6)
          write(15,360) xv2(1),xv2(2),xv2(3),xv2(4),xv2(5),xv2(6)
        endif
c        write(*,*) i
      enddo
c      goto 50
...
C ---------------------------------------------------------------------
      subroutine approach(ea,eb,fkpo,fapo,rpo,xv1,fkpre,fapre,rpre,xv2)
C ---------------------------------------------------------------------
