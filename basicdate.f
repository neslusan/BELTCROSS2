...
c Version: September 6, 2022
      ...
      dimension isol(1500),iau(1500),jnn(1500),xv(6)
  ...
  90  continue
      ...
      read(12,*) xv(1),xv(2),xv(3),xv(4),xv(5),xv(6)
      read(12,*) vax,vay,vaz,vshx,vshy,vshz
      iok=0
      do ii=1,jsh
     ...
     *,skx,rast,vrel,angl
      write(15,320) xv(1),xv(2),xv(3),vax,vay,vaz,vshx,vshy,vshz
      endif
      goto 90
 120  continue
      close(unit=12)
