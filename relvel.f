...
c Version: September 7, 2023
  ...
  10  continue
      ...
      read(11,*) xv1(1),xv1(2),xv1(3),xv1(4),xv1(5),xv1(6)
      read(11,*) xv2(1),xv2(2),xv2(3),xv2(4),xv2(5),xv2(6)
      jarc1=0
      if(rpost.le.rcrit) then
        ...
        write(15,370) xv1(1),xv1(2),xv1(3),xv1(4),xv1(5),xv1(6)
        write(15,380) vax1,vay1,vaz1,vshx1,vshy1,vshz1
      endif
      ...
      if(rpre.le.rcrit) then
        ...
        write(15,360) iau,isol,jnn,-1
        write(15,370) xv2(1),xv2(2),xv2(3),xv2(4),xv2(5),xv2(6)
        write(15,380) vax2,vay2,vaz2,vshx2,vshy2,vshz2
      endif
      goto 10
  50  continue
      close(unit=11)
